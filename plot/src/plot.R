...
files <- list(
  drc1_Ct694_clean = here("plot/input/drc1_Ct694_cleanobs.csv"),
  drc1_LFA_clean = here("plot/input/drc1_LFA_cleanobs.csv"),
  drc1_MBA_clean = here("plot/input/drc1_MBA_cleanobs.csv"),
  drc2_Ct694_clean = here("plot/input/drc2_Ct694_cleanobs.csv"),
  drc2_LFA_clean = here("plot/input/drc2_LFA_cleanobs.csv"),
  drc2_MBA_clean = here("plot/input/drc2_MBA_cleanobs.csv"),
  togoLFAf_41_clean = here("plot/input/togoLFAf_41_cleanobs.csv"),
  togoLFAf_42_clean = here("plot/input/togoLFAf_42_cleanobs.csv"),
  togoLFAg_41_clean = here("plot/input/togoLFAg_41_cleanobs.csv"),
  togoLFAg_42_clean = here("plot/input/togoLFAg_42_cleanobs.csv"),
  togoLFAl_41_clean = here("plot/input/togoLFAl_41_cleanobs.csv"),
  togoLFAl_42_clean = here("plot/input/togoLFAl_42_cleanobs.csv"),
  togoMBAc_41_clean = here("plot/input/togoMBAc_41_cleanobs.csv"),
  togoMBAc_42_clean = here("plot/input/togoMBAc_42_cleanobs.csv"),
  togoMBAp_41_clean = here("plot/input/togoMBAp_41_cleanobs.csv"),
  togoMBAp_42_clean = here("plot/input/togoMBAp_42_cleanobs.csv"),

  drc1_CT694_obs = here("plot/input/drc1_Ct694_obs.csv"),
  drc1_LFA_obs = here("plot/input/drc1_LFA_obs.csv"),
  drc1_MBA_obs = here("plot/input/drc1_MBA_obs.csv"),
  drc2_CT694_obs = here("plot/input/drc2_Ct694_obs.csv"),
  drc2_LFA_obs = here("plot/input/drc2_LFA_obs.csv"),
  drc2_MBA_obs = here("plot/input/drc2_MBA_obs.csv"),
  togoLFAf_41_obs = here("plot/input/togoLFAf_41_obs.csv"),
  togoLFAf_42_obs = here("plot/input/togoLFAf_42_obs.csv"),
  togoLFAg_41_obs = here("plot/input/togoLFAg_41_obs.csv"),
  togoLFAg_42_obs = here("plot/input/togoLFAg_42_obs.csv"),
  togoLFAl_41_obs = here("plot/input/togoLFAl_41_obs.csv"),
  togoLFAl_42_obs = here("plot/input/togoLFAl_42_obs.csv"),
  togoMBAc_41_obs = here("plot/input/togoMBAc_41_obs.csv"),
  togoMBAc_42_obs = here("plot/input/togoMBAc_42_obs.csv"),
  togoMBAp_41_obs = here("plot/input/togoMBAp_41_obs.csv"),
  togoMBAp_42_obs = here("plot/input/togoMBAp_42_obs.csv"),

  drc1_CT694_mod = here("plot/input/drc1_Ct694_model_ests.csv"),
  drc1_LFA_mod = here("plot/input/drc1_LFA_model_ests.csv"),
  drc1_MBA_mod = here("plot/input/drc1_MBA_model_ests.csv"),
  drc2_CT694_mod = here("plot/input/drc2_Ct694_model_ests.csv"),
  drc2_LFA_mod = here("plot/input/drc2_LFA_model_ests.csv"),
  drc2_MBA_mod = here("plot/input/drc2_MBA_model_ests.csv"),
  togoLFAf_41_mod = here("plot/input/togoLFAf_41_model_ests.csv"),
  togoLFAf_42_mod = here("plot/input/togoLFAf_42_model_ests.csv"),
  togoLFAg_41_mod = here("plot/input/togoLFAg_41_model_ests.csv"),
  togoLFAg_42_mod = here("plot/input/togoLFAg_42_model_ests.csv"),
  togoLFAl_41_mod = here("plot/input/togoLFAl_41_model_ests.csv"),
  togoLFAl_42_mod = here("plot/input/togoLFAl_42_model_ests.csv"),
  togoMBAc_41_mod = here("plot/input/togoMBAc_41_model_ests.csv"),
  togoMBAc_42_mod = here("plot/input/togoMBAc_42_model_ests.csv"),
  togoMBAp_41_mod = here("plot/input/togoMBAp_41_model_ests.csv"),
  togoMBAp_42_mod = here("plot/input/togoMBAp_42_model_ests.csv")
)
